...
namespace App;
    class ZKLib {
        ...
        public function __construct($ip, $port) {
            ...
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkconst.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkconnect.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkversion.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkos.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkplatform.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkworkcode.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkssr.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkpin.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkface.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkserialnumber.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkdevice.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkuser.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zkattendance.php");
            include_once(base_path()."/vendor/krinn/zk-attend/zklib/zktime.php");
        }
